...
public class Main extends Application {
    ...
    public void start(Stage stage) {
        ...
        TextArea paragraph = new TextArea("The overall allocation of resources could be thought of as a train trolley problem. In each business modality, habits are part of the unconscious-subconscious business process, while goals are part of the subconscious-conscious business function. Converting this with compelx typography may allow for many runs to be understandable similar as an encyclopedia.");
